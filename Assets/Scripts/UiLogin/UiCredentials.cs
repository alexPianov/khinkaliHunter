...
{
    public class UiCredentials : MonoBehaviour
    {
        [Header("Input")]
        ...
        {
            buttonRegistration.interactable = false;
            var dataRequest = new AddUsernamePasswordRequest
            {
            ...
            var resultData = await AddUsernamePasswordRequest(dataRequest);
            if (resultData == null) 
            { 
        ...
        public async UniTask<AddUsernamePasswordResult> AddUsernamePasswordRequest
            (AddUsernamePasswordRequest request)
        {
            operationFinish = false;
            AddUsernamePasswordResult operationResult = null;
